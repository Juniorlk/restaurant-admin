        ...
        series: [
          {
            ...
            barGap: "48%",
            showBackground: !0,
            backgroundStyle: { color: e(t("primary-soft"), t("gray-100")) },
            label: { show: !1 },
      ...
      if (window.List) {
        ...
        t.length &&
          t.forEach((t) => {
            ...
            const f = () => {
              c &&
                (c.innerHTML = `${g.i} to ${b} <span class='text-600'> Items of </span>${d}`),
          ...
          if (c.data("theme-control")) {
            ...
            switch (
              ("phoenixTheme" === l &&
                "boolean" == typeof d &&
                (d = d ? "dark" : "light"),
              config.hasOwnProperty(l) && window.config.set({ [l]: d }),
              ...
              case "phoenixTheme": {
                ...
                const t = new CustomEvent("clickControl", {
                  detail: { control: l, value: d },
                });
                e.currentTarget.dispatchEvent(t), changeTheme(a.node);
                break;
              }
              ...
              case "phoenixNavbarPosition":
                ...
                break;
              case "phoenixIsRTL":
                window.config.set({ phoenixIsRTL: c.node.checked }),
            ...
            "phoenixTheme" === t &&
              o.forEach((t) => {
                window.tinymce
                  .get(t.id)
                  .dom.addStyle(
                    `.mce-content-body{color: ${e("black")} !important;}`
                  );
              });
          });
      }
